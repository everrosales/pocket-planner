...
templates['todos'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "  <div class=\"column\" id=\"todo-container\">\n    <p class=\"category\">"
    + container.escapeExpression(((helper = (helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},{"name":"name","hash":{},"data":data}) : helper)))
    + "</p>\n"
  ...
  return "<div id=\"category-container\">\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.categories : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.program(3, data, 0),"data":data})) != null ? stack1 : "")
    + "  <div class=\"column btn btn-default\" id=\"new_todo\">\n    <p>+ Add a new To-Do list</p>\n  </div>\n  <div id=\"edit_event\">\n    <p> edit event blabla</p>\n\n  </div>\n</div>\n";
},"usePartial":true,"useData":true});
})();